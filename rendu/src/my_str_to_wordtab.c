...
** Last update Thu Oct  8 16:02:42 2015 Julien Wuillaume
*/
...
char	**wordtab_initialize_array(char **array, int size)
{
  int	i;
...
char	**my_str_to_wordtab(char *str)
{
  ...
  words = wordtab_initialize_array(words, str_word_count(str));
